    ...
    <div className="relative container py-28 md:py-36">
      <div className="max-w-3xl">
        ...
        <p className="text-sm font-semibold uppercase tracking-widest text-accent mb-6 opacity-90">
          Haulage & Transport Contractor · Kilkenny
        </p>

        <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white leading-[1.05] tracking-tight mb-8">
          Haulage from Kilkenny<br />
          Built on <span className="text-accent">Reliability</span>
        </h1>

        <p className="text-lg md:text-xl text-white/80 mb-12 leading-relaxed max-w-xl">
          Paul Mernagh Transport operates across Leinster and beyond, delivering goods safely and on schedule from a Kilkenny base.
        </p>
